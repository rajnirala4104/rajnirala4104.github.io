            ...
            <div className="firstImpressionContainer">
                <div className="firstImpressionLeftSectionContent">
                    ...
                    <div className="firstImpressionLeftSectionBtns">
                        ...
                        <a type="button" href='https://docs.google.com/document/d/1erh9VMHEh4H6Aek61cXj5w_x0RAoFA_n03WCV0Y7LXA/edit?usp=sharing' target='_blank' rel="noreferrer" className="btn cvBtn bg-outline-dark border-dark" >Download CV</a>
                    </div>
                </div>
                <div className="firstImpressionRightSectionContent">
                    <img loading="lazy" src={require('../Asserts/images/rajnirala.png')} alt="raj nirala" />
                </div>
            </div>
        </>
    )
