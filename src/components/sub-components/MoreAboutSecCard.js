  ...
  return (
    <Fragment>
      <Suspense fallback="loading..">
        <div
          className="rounded-md shadow-lg p-2 bg-fixed lg:bg-current h-[30rem] lg:w-[42%] flex justify-center items-center mb-3 lg:saturate-[60%] transition-all lg:hover:saturate-100"
          style={{
