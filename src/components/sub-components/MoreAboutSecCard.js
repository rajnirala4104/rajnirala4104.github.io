  ...
  return (
    <Fragment>
      <Suspense fallback="loading..">
        <div
          className=" lg:hidden bg-fixed rounded-md shadow-lg p-2  lg:bg-current h-[30rem] lg:w-[22%] flex justify-center items-center mb-3 saturate-[100%] lg:saturate-[0%] transition-all lg:hover:saturate-100"
          style={{
