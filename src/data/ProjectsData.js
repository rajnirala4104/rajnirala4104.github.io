...
export const ProjectsData = [
   {
      ...
      projName: "E-Library",
      projDescription:
         "This is an e-commerce website where all types of books are sold. This website is made of React - My Friend's MINOR PROJECT 😁",
      codeLink: "https://github.com/rajnirala4104/E-Lib",
   },
   {
      img: allProjectImages.ula_LawFirm,
   ...
   {
      img: allProjectImages.tellTheNews,
   ...
   {
      img: allProjectImages.translatorWithGUI,
      projName: "Translator",
      projDescription:
